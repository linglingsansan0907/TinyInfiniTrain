...
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MeanForward, infini_train::kernels::cpu::MeanForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MeanBackward, infini_train::kernels::cpu::MeanBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, SumForward, infini_train::kernels::cpu::SumForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, SumBackward, infini_train::kernels::cpu::SumBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MaxForward, infini_train::kernels::cpu::MaxForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MaxBackward, infini_train::kernels::cpu::MaxBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MinForward, infini_train::kernels::cpu::MinForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, MinBackward, infini_train::kernels::cpu::MinBackward);
