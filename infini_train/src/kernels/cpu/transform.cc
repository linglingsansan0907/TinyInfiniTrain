...
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TrilForward, infini_train::kernels::cpu::TrilForward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TrilBackward, infini_train::kernels::cpu::TrilBackward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TriuForward, infini_train::kernels::cpu::TriuForward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TriuBackward, infini_train::kernels::cpu::TriuBackward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TransposeForward, infini_train::kernels::cpu::TransposeForward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, TransposeBackward, infini_train::kernels::cpu::TransposeBackward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, MaskForward, infini_train::kernels::cpu::MaskForward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, MaskBackward, infini_train::kernels::cpu::MaskBackward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, RepeatInterleaveForward, infini_train::kernels::cpu::RepeatInterleaveForward);
// REGISTER_KERNEL(infini_train::DeviceType::kCPU, RepeatInterleaveBackward, infini_train::kernels::cpu::RepeatInterleaveBackward);
