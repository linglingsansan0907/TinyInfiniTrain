...
REGISTER_KERNEL(infini_train::DeviceType::kCPU, CrossEntropyForward, infini_train::kernels::cpu::CrossEntropyForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, CrossEntropyBackward, infini_train::kernels::cpu::CrossEntropyBackward);
