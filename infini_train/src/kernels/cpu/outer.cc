...
REGISTER_KERNEL(infini_train::DeviceType::kCPU, OuterForward, infini_train::kernels::cpu::OuterForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, OuterBackward, infini_train::kernels::cpu::OuterBackward);
