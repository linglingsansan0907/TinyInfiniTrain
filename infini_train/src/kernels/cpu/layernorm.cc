...
REGISTER_KERNEL(infini_train::DeviceType::kCPU, LayerNormForward, infini_train::kernels::cpu::LayerNormForward);
REGISTER_KERNEL(infini_train::DeviceType::kCPU, LayerNormBackward, infini_train::kernels::cpu::LayerNormBackward);
