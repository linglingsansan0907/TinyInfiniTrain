...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, SoftmaxForward, SoftmaxForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, SoftmaxBackward, SoftmaxBackward);
