...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MeanForward, infini_train::kernels::cuda::MeanForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MeanBackward, infini_train::kernels::cuda::MeanBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, SumForward, infini_train::kernels::cuda::SumForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, SumBackward, infini_train::kernels::cuda::SumBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MaxForward, infini_train::kernels::cuda::MaxForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MaxBackward, infini_train::kernels::cuda::MaxBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MinForward, infini_train::kernels::cuda::MinForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MinBackward, infini_train::kernels::cuda::MinBackward);
