...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, CrossEntropyForward, infini_train::kernels::cuda::CrossEntropyForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, CrossEntropyBackward, infini_train::kernels::cuda::CrossEntropyBackward);
