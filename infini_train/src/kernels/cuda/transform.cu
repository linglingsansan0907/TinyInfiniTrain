...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TrilForward, infini_train::kernels::cuda::TrilForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TrilBackward, infini_train::kernels::cuda::TrilBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TriuForward, infini_train::kernels::cuda::TriuForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TriuBackward, infini_train::kernels::cuda::TriuBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TransposeForward, infini_train::kernels::cuda::TransposeForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, TransposeBackward, infini_train::kernels::cuda::TransposeBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MaskForward, infini_train::kernels::cuda::MaskForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, MaskBackward, infini_train::kernels::cuda::MaskBackward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, RepeatInterleaveForward, infini_train::kernels::cuda::RepeatInterleaveForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, RepeatInterleaveBackward, infini_train::kernels::cuda::RepeatInterleaveBackward);
