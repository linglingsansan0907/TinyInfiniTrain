...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, LayerNormForward, infini_train::kernels::cuda::LayerNormForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, LayerNormBackward, infini_train::kernels::cuda::LayerNormBackward);
