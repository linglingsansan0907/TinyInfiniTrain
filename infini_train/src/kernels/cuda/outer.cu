...
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, OuterForward, infini_train::kernels::cuda::OuterForward);
REGISTER_KERNEL(infini_train::DeviceType::kCUDA, OuterBackward, infini_train::kernels::cuda::OuterBackward);
